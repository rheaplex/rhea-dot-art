...
<http://creativecommons.org/licenses/by/4.0/> (after the original).

Blockchain Hashes (simple-net-art-diagram.gif)

Note that these are for the unmodified version (which was also included in Rhizome’s net.art anthology book “The Art Happens Here”).
