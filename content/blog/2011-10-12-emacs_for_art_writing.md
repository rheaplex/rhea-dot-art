...
](http://orgmode.org/)Specifically for art writing, I've written an Emacs "minor mode" that highlights mistakes such as use of the passive voice, weasel words, art writing cliches ("artbollocks"), and lexical illusions (duplicate words) - [https://github.com/rheaplex/scripts/blobs/master/artbollocks-mode.el  
  
](https://github.com/rheaplex/scripts/blobs/master/artbollocks-mode.el)Learning how to use Emacs is an investment that pays off massively,
