...
As with the concept of the [negative freedom](https://en.wikipedia.org/wiki/Negative_liberty) of free speech, “code is law” can become (mis)understood as a positive, prescriptive norm in environments that collapse the distinction between expression and effect by embodying them in software. For Ethereum no less than for [LambdaMOO](https://mitpress.mit.edu/books/crypto-anarchy-cyberstates-and-pirate-utopias), all the world is code and to speak is to change that world. Code is speech, after all, as *[Bernstein v. Department of Justice](https://www.eff.org/deeplinks/2015/04/remembering-case-established-code-speech)* established in the US.

“Code is law” became an early slogan of the Ethereum Comunity. Inspired by Nick Szabo’s concept of “s[mart contracts](https://nakamotoinstitute.org/the-idea-of-smart-contracts/)” and the possibility of organizing human collaboration and allocating economic resources on the blockchain, this made sense. To model contracts in software that runs independently of human control makes code law in a more literal way than internet protocols do.

And then the DAO hack happened.

A single bug in “[The DAO](https://en.wikipedia.org/wiki/The_DAO_(organization))“, code running on the Ethereum blockchain to gather and manage investments in new projects, allowed an attacker to start draining fifty million dollars worth of cryptocurrency from it into their own account. As the attack progressed the community tried different strategies to slow down or stop it, but they could not reverse it.
...
While I was writing this essay news came in of a series of [51% attacks](https://dci.mit.edu/51-attacks) on Ethereum Classic, with an attacker rolling back its blockchain over a thousand blocks in one instance. The response of Ethereum Classic’s developers has been [to retain lawyers](https://www.theblockcrypto.com/linked/74305/etc-blockchain-attacks-ciphertrace-investigation) off-chain.

If code is law is the use of code on computers to bring [hash power](https://www.coindesk.com/ethereum-classic-plan-51-attacks-rent-hashing) to bear on a blockchain also law? At the level of the code that runs the Ethereum Classic blockchain, yes it is (I am not a lawyer, and I mean this in the same sense as the original statement that “code is law”…). A 51% attack is simply a choice of which chain to mine with which software. This is how the Ethereum Classic Chain came into existence in the first place.
