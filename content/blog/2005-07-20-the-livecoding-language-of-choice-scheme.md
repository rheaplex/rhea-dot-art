...
Livecoding is the creation of music or animation by programming live in front of an audience. [Dave Griffith](http://www.pawfal.org/) has a system called '[fluxus](http://www.pawfal.org/Software/fluxus/)' that I've mentioned before. Notice all the brackets around the code, that's a hallmark of Scheme:  


  
![ Software Fluxus Images Spasm](/images/_Software_fluxus_images_spasm.jpg)  


  
And here's Andrew Sorensen and Andrew Brown performing using ['impromptu](http://acmc.ci.qut.edu.au/program.html)' in Brisbane. More brackets:  


  
![P7140292 1](/images/P7140292_1.jpg)  
...
Technorati Tags: [art](http://technorati.com/tag/art), [generative art](http://technorati.com/tag/generative art), [graphics](http://technorati.com/tag/graphics), [music](http://technorati.com/tag/music), [livecoding](http://technorati.com/tag/livecoding)
