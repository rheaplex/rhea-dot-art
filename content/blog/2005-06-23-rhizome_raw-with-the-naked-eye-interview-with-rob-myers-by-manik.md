...
date = 2005-06-23
path = "/2005/06/23/rhizome_raw-with-the-naked-eye-interview-with-rob-myers-by-manik/"
+++
...
It depends how strong the technology and the user are. Or maybe how strong their aesthetics are? In [Surgical Strike](https://rhea.art/surgical_strike) I think I assumed that the technology, and the ideology it presupposed, was more powerful. I wouldn’t be so defeatist now. As William Gibson said, “the street finds its own uses for things”.
...
The best example of this connection is [Surgical Strike](https://rhea.art/surgical_strike), that was about, how the history of a technology (
computing) that has come from a particular ideology (American militarism) may affect attempts to make an aesthetic (computer art). But [1968](https://rhea.art/nineteen-sixty-eight) and [1969](https://rhea.art/1969) are about that as well, and [Psychetecture](https://rhea.art/psychetecture) was about how architecture serves capital by affecting your perceptions.
...
The series that are most obviously remix based are my early [Mixes](https://rhea.art/mixes) and sampling based work, [Surgical Strike](https://rhea.art/surgical_strike), [1968](https://rhea.art/nineteen-sixty-eight) and [1969](https://rhea.art/nineteen-sixty-nine), and [Canto](https://rhea.art/canto).

But my work always uses the ideas and imagery of others. [Psychetecture](https://rhea.art/psychetecture) was based on the calligrams of Ahmed Mustafah, [Titled](https://rhea.art/titled) uses colour diagrams from famous twentieth century artists and I’ve mentioned the designers that influenced me. The only work I’ve made that wasn’t directly influenced by anyone else is [San Jose](https://rhea.art/san_jose), which I regard as my weakest work.
...
But I am open to accident and humour (and embarrassment) in my work, so once I realised that the first work ([Canto](https://rhea.art/canto) For Evie) looked like Mattise, I decided to make more work from the same source material. And I had to re-evaluate Mattisse, who I didn’t like before. I’m now doing some paper cut-outs.
...
A perky Romanticism. My [Smileys](https://rhea.art/smileys) are the art Munch would have made if he’d had access to a Macintosh and a prescription for Prozac. 🙂
