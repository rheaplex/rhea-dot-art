...
Kinda like a negative Turing test. A guy at Middlesex did unseen computer art before I was there, but this is a step beyond that. The producer/consumer pair reminds me of [ae](http://rheart.sourceforge.net/rheart/ae.html) from [rheart](http://rheart.sourceforge.net/), which was based on ideas from [Algorithmic Aesthetics](http://www.algorithmicaesthetics.org/).
